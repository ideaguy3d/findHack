...
(function () {
    ...
    function PresentTablesClass($rootScope, edhubAuthService, eOrgListFact, $http, $interval) {
        let progress;
        const vm = this;
        ...
        */
        ...
        const reqStr = "http://localhost/sv2/?v=2&get_uri=present";

        // TODO: wrap $http into a service and hit our back end ^_^
        $http.get(reqStr).then(function (res) {
            vm.presentTableData = res.data;
        });
